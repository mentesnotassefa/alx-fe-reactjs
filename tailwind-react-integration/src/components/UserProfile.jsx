function UserProfile() {
    return (
      <div className="bg-gray-100 p-8 max-w-sm mx-auto max-w-xs my-20 rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-sm md:max-w-sm">
        ...
        <p className="text-gray-600 text-base sm:text-sm md:text-base sm:h-24 md:h-36">Developer at Example Co. Loves to write code and explore new technologies.</p>
      </div>
    );
  }
